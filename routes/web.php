...
Route::group(['middleware' => ['only_broker_access', 'is_verify_email', 'is_document_approved']], function () {
    Route::group(['prefix' => '/'], function () {
        Route::get('bidding-detail', ['as' => 'bidding-detail', 'uses' => 'BrokerController@biddingDetail']);
        Route::post('bidding-detail', ['uses' => 'BrokerController@store']);
    });
});
...
Route::get('biddable-properties', 'BiddablePropertyController@index')->name('biddable-properties');


Route::get('biddable-properties/{property_slug}', 'BiddablePropertyController@showSelectedPropertyDetail')->name('show-selected-property-detail');
Route::post('show-property-detail', 'BiddablePropertyController@showPropertyDetail')->name('show-property-detail');
Route::get('approve_documents/{bidding_detail_id}', 'BrokerController@approveDocuments')->name('approve_documents');


//Route::post('register-broker', 'BiddablePropertyController@registerBroker')->name('register-broker');
...
Route::get('account/verify/{token}', 'Auth\RegisterController@verifyAccount')->name('user.verify');

//Route::get('test', function () {
//
//    Mail::send('email.emailVerificationEmail', ['token' => 'abc'], function ($message) {
